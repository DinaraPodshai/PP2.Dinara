...
FramePerSec = pygame.time.Clock() #ля ограничения скорости.
...
SPEED = 5
SCORE = 0
pygame.mixer.music.load('tsis8_racer_background.wav')
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.transform.scale(pygame.image.load("Player.png"), (50, 85))
        self.rect = self.image.get_rect()
        self.rect.center = (200, 500)
       
    def move(self): #вызывается каждый кадр.
